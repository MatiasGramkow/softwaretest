...
public enum ErrorEnum
{
    ...
    USER_DOES_NOT_EXIST_ARGUMENT(Status.INTERNAL_SERVER_ERROR, USER_DOES_NOT_EXIST),
    PASSWORD_DOES_NOT_MATCH_ARGUMENT(Status.INTERNAL_SERVER_ERROR, PASSWORD_DOES_NOT_MATCH)
